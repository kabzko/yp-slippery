...
const ForgotPasswordSendEmailModal = React.lazy(() => import('./modal/ForgotPasswordSendEmailModal'));
    ...
    <div className='relative flex flex-col items-center justify-between px-6 pt-[100px] mx-auto h-screen '>
      ...
      <div className='shadow-lg rounded-[30px] md:mt-0 xl:w-[500px] lg:w-[500px] sm:w-[400px] px-14 h-auto bg-white z-10 pt-14 pb-14'>
            ...
            <div className='w-full flex flex-col space-y-1 mt-6 px-6'>
              ...
              <div>
                <button
                  id='signin-button'
                  type='submit'
                  className='w-full h-11 text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-500 font-semibold rounded-xl text-sm px-5 py-2.5 text-center mb-2 disabled:opacity-50'
                  tabIndex={2}
                  disabled={process}
                >
                  Submit
        ...
        <Link
          id='back-to-login'
          to='/signin'
          className='underline flex justify-center text-indigo-dye text-blue-600 text-sm font-semibold pb-4'
          tabIndex={3}
        >
          Back to Sign In
        </Link>
