...
const ForceChangePasswordModal = ({ isOpen, onClose, process, submit }: { isOpen: boolean, onClose: () => void, process: boolean, submit: (password: string, confirmPassword: string) => void }) => {
            ...
            >
              <Dialog.Panel className='relative transform overflow-hidden rounded-lg bg-white pb-4 text-left shadow-xl sm:my-8 w-[520px]'>
                <div className='flex flex-col items-center'>
                  <h1 className='text-2xl text-center font-bold leading-none tracking-tight text-indigo-dye lg:text-[25px] mb-2 mt-10'>
                ...
                <div className='px-6 pb-6 pt-2 space-y-2 sm:p-8'>
                  <div className='mb-4'>
                    <p className='text-sm text-center font-normal'>
                      Please make sure your password contains one uppercase letter, one lowercase letter, one number,
                      one character, and atleast 8 characters long.
                    </p>
                  </div>
                  <div>
                    <form onSubmit={onSubmit}>
                      ...
                      <div className='px-6'>
                        <button
                          id='confirm-button'
                          type='submit'
                          className='w-full h-11 text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-500 font-semibold rounded-3xl text-sm px-5 py-2.5 text-center my-5 disabled:opacity-50'
                          tabIndex={5}
                          disabled={process}
                        >
                          Change Password
...
ForceChangePasswordModal.propTypes = {
