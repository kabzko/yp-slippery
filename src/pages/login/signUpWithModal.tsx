                ...
                <div className='flex flex-col'>
                  ...
                  <div className='flex space-x-4 hover:cursor-pointer'>
                    <div className='flex space-x-4'>
                      <div className='w-[183px] h-[45px] hover:cursor-pointer group flex relative'>
                        <div
                  ...
                  <div className='space-y-4'>
                    <div className='flex space-x-4'>
                      ...
                      >
                        ...
                        >
                          <img src={static_images.google_logo} className='w-[18px] h-[18px]' alt='Google' />
                          <h1>Google</h1>
                        </div>
                      </div>
                      <div className='w-[183px] h-[45px] hover:cursor-pointer group flex relative'>
                    ...
                    <div className='flex space-x-4'>
                      <div className='w-[183px] h-[45px] hover:cursor-pointer group flex relative'>
                        ...
                        >
                          <img src={static_images.facebook_logo} className='w-[24px] h-[24px]' alt='yahshua' />
                          <h1>Facebook</h1>
                        </div>
                        <span className='absolute z-40 w-[120px] bottom-12 scale-0 rounded-lg bg-[#344960] p-2 text-white group-hover:scale-100 flex'>
                          <h1 className='text-sm'>Coming Soon</h1>
                      ...
                      <div className='w-[183px] h-[45px] hover:cursor-pointer group flex relative'>
                        ...
                        >
                          <img src={static_images.yahshua_logo} className='w-[24px] h-[24px]' alt='yahshua' />
                          <h1>YAHSHUA</h1>
                        </div>
                        <span className='absolute z-40 w-[120px] bottom-12 scale-0 rounded-lg bg-[#344960] p-2 text-white group-hover:scale-100 flex'>
                          <h1 className='text-sm'>Coming Soon</h1>
