...
import { SelfServiceContext, ProgressIndicatorContext } from "../../../contexts";
...
const Content = () => {
	...
	// const overallProgress = progressState.overallProgress;
		...
		<>
			<SelfServiceContext.Provider value={{ selectedRows, setSelectedRows, step, setStep }}>
				<div className="flex flex-col h-screen">
					<Stepper step={step} />
					<div className="flex flex-col content-center justify-center py-5 bg-fixed bg-center bg-no-repeat bg-cover xl:px-40 gap-y-5 bg-origin-content" style={{ height: 'inherit', alignItems: 'center', backgroundImage: `url(${backgroundImage})` }}>
