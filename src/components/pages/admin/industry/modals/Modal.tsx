          ...
          <div className='inline-block overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:pb-6'>
            <div className='text-center sm:text-left'>
              <div className='flex justify-center mt-2 sm:p-6'>
                <svg width='56' height='83' viewBox='0 0 56 83' fill='none' xmlns='http://www.w3.org/2000/svg'>
                  ...
                  <path
                    ...
                    fill='#010F7C'
                  />
                  <path d='M0 4.99178L12.957 0.00585938V75.2392L0 82.0353V4.99178Z' fill='#02B3BE' />
                </svg>
              </div>
              ...
              <h1 className='px-6 pt-5 pb-4 text-xl font-bold text-center'>
                To initiate the process, kindly prepare all relevant company information, encompassing{' '}
                {selectedIndustry === '3' ? (
                  <span className='text-xl font-bold text-blue-700'>
                    Location, Department, Position, Employment Type, Division, Section, Unit, Sub Unit and Schedule.
                  </span>
                ) : (
                  <span className='text-xl font-bold text-blue-700'>
