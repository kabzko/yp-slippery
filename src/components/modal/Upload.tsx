              ...
              <div className='csv-file-div'>
                <div className='text-center border-b-2 sm:text-left'>
                  <div className='flex justify-between w-full p-2 bg-blue-600'>
                    <h3 className='text-lg font-medium leading-6 text-white'>Upload File</h3>
                  ...
                  <div className='mt-2 sm:p-6'>
                    <div onDragEnter={handleDrag} onDragLeave={handleDrag} onDragOver={handleDrag} onDrop={handleDrop}>
                      ...
                      <div className={classNames('', file !== null ? 'csv-file-preview' : 'hidden')}>
                        <img width='25' height='25' src='https://img.icons8.com/ios/25/csv.png' alt='csv' />
                        <p className='text-sm font-light text-slate-800'>{file?.name}</p>
                        <p className='text-blue-500 underline cursor-pointer' onClick={() => setFile(null)}>
                          Remove File
                        </p>
                      </div>
                    </div>
                ...
                <div className='pr-6 mt-5 sm:mt-4 sm:flex sm:flex-row-reverse sm:pl-6'>
                  ...
                  <span className='flex w-full mt-3 rounded-md shadow-sm sm:mt-0 sm:w-auto'>
                    <button onClick={onClose} type='button' className='cancel-upload-csv-btn'>
                      Cancel
                    </button>
                  </span>
                </div>
